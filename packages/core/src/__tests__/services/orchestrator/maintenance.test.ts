...
describe('log-analyzer', () => {
  ...
  it('should return empty results when no log files exist', async () => {
    const { analyzeLogs } = await import('../../../services/orchestrator/log-analyzer.ts');
...
vi.mock('node:util', async () => {
  const actual = await vi.importActual<typeof NodeUtil>('node:util');
  return {
    ...actual,
...
describe('dependency-checker', () => {
  ...
  it('should parse npm outdated output and classify updates', async () => {
    ...
    const { checkDependencies } =
      await import('../../../services/orchestrator/dependency-checker.ts');
...
describe('resource-monitor', () => {
  ...
  it('should report file sizes and flag concerns for missing health endpoint', async () => {
    ...
    const { checkResources } = await import('../../../services/orchestrator/resource-monitor.ts');
...
describe('maintenance-report', () => {
  ...
  it('should compile a report and write to disk', async () => {
    const { compileReport } = await import('../../../services/orchestrator/maintenance-report.ts');
...
describe('maintenance-runner service (integration)', () => {
  ...
  it('should register maintenance:run handler on start', async () => {
    vi.resetModules();
    const mod = await import('../../../services/orchestrator/maintenance-runner.ts');
