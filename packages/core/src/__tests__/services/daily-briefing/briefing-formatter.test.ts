...
describe('briefing-formatter service', () => {
    ...
    emails: [
      {
        ...
        from: 'John Smith',
        subject: 'Q1 Results',
        snippet: 'need your input on the...',
        isUrgent: true,
      },
      {
        id: 'email2',
  ...
  beforeEach(async () => {
    ...
    const mod = await import('../../../services/daily-briefing/briefing-formatter.ts');
    service = mod.default;
  });
  ...
  describe('edge cases', () => {
    ...
    it('handles empty emails array', async () => {
      ...
      emitTaskComplete(
        JSON.stringify({
          tasks: [
            { id: 't1', title: 'Do stuff', dueDate: '2026-03-15', isOverdue: false, project: null },
          ],
          emails: [],
          systemStatus: 'OK',
        }),
